...
def ip_cam():
    ...
    address = "http://192.168.0.111:8080/video"
    cap.open(address)
    cap.set(3, 640)
    cap.set(4, 480)
    global i
...
##################################################IT USED FOR RADIO BUTTONS ###################################################################
    ...
    Button(f3,text="Apply",padx= 10,command = option, bg = "#BB8FCE" ,fg = "#FFFFFF",activebackground="#FFFFFF",activeforeground= "#BB8FCE",font ="comicsansms 15 bold").pack(padx = 5,pady = 5,ipadx = 0,ipady = 0)
