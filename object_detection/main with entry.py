...
if __name__ == "__main__": 
    ...
    f3.grid(row = 0,column = 1,padx =25,pady= 25)
    ...
    f5.grid(row=2, columnspan=2,padx =25,pady= 25)
    f6 = Frame(f0,bg = "#BB8FCE", borderwidth=3)
    f6.grid(row=3, columnspan=2,padx =25,pady= 25)
    ...
    # process_vdo.grid(row = 1,column = 2)
    process_web_cam.grid(row=2, columnspan=2,padx = 5,pady = 5,ipadx =0,ipady = 0)#, fill= "y",padx = 5,pady = 5

    process_stop = Button(f6,text ="Stop",bg = "#BB8FCE" ,fg = "red"
                ,font = #("comicsansms", 12 , "bold")
